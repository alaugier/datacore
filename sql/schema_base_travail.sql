...
CREATE TABLE commandes_clients (
  ...
  entrepot       VARCHAR(20),
  CONSTRAINT uq_commandes_clients_client_commande UNIQUE (client, commande_id)
);
...
CREATE TABLE lignes_commande_clients (
  ...
  CONSTRAINT uq_lignes_commande_clients_commande_sku UNIQUE (commande_client_id, sku)
);
